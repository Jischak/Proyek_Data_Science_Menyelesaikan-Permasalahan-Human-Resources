    ...
    with st.expander("Bagaimana sih cara menggunakan dasbor ini?"):
        st.write(
            """
                ...
                1. Masukan dulu dataset yang sesuai pada menu "Masukan Dataset" dibawah. Dataset-nya dimana? Bisa didownload dari github/hasil output notebook.ipynb dengan nama file df_employee_for_ML.
                2. Kalo datasetnya sudah muncul, mantapss...
                3. Lanjutkan!!! klik tombol "Prediksi Status Karyawan"
                4. Eits, yang sabar ya tunggu proses prediksi-nya...
                5. Kalau sudah muncul hasil prediksinya, yeeey Selamat ya Kamu Berhasil...
            """
        )
